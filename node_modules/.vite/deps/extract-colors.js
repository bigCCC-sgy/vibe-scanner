...
var EXTRACTOR_PIXELS_DEFAULT = 64e3;
var EXTRACTOR_DISTANCE_DEFAULT = 0.22;
var AVERAGE_HUE_DEFAULT = 1 / 12;
var AVERAGE_SATURATION_DEFAULT = 1 / 5;
var AVERAGE_LIGHTNESS_DEFAULT = 1 / 5;
function testInputs({
...
var checkIsBrowser = () => typeof window !== "undefined" && typeof window.document !== "undefined";
var checkIsWorker = () => typeof self === "object" && self.constructor && self.constructor.name === "DedicatedWorkerGlobalScope";
var checkIsNode = () => typeof window === "undefined" && // eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
...
var extractImageData = (_image, _pixels) => {
...
var extractColorsFromImage = async (image, options = {}) => {
  if (checkIsNode()) {
    if (true) {
      throw new Error(
...
var extractColorsFromImageBitmap = async (image, options = {}) => {
  if (checkIsNode()) {
    if (true) {
      throw new Error(
...
var extractColorsFromSrc = async (src, options = {}) => {
  if (checkIsNode()) {
    if (true) {
